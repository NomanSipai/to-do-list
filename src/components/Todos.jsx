...
const Todos = () => {
  ...
  return (
    <div className=" md:w-3/4 me-auto ms-auto mt-16 bg-[#b4cab8] mb-10 rounded ">
      <div className="bg-[#99b79e] font-bold text-xl p-3 mb-5 flex justify-between items-center">
        TASK LIST
        <input
          type="text"
          name="price"
            ...
            .map((item) => {
              return (
                <div
                  ...
                  } space-y-3 p-4 rounded-lg shadow`}>
